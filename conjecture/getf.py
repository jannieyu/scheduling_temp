# Generalized Earliest Task First Algorithm
# Takes a sequence of nodes (i.e. tasks)
# Edges, and their respective weights (computational time)
# Given a set of machines (with varying computation power)
# Determines which machines to run them on
    ...
    def getf(self):
        ...
        while len(done) < self.n:
            ...
            for j in A:
                ...
                possible_tasks.append([j, earliest_time, earliest_machine])
            ...
            # print("Choosing -- Task " + str(j) + " task_starts at " + str(tj) + " on machine " + str(mj))
            ...
            for child in self.G.successors(j):
